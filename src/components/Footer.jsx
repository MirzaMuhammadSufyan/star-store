...
const COLS = {
  ...
  Company: [{ l: 'About Us', p: '/about' }, { l: 'Journal', p: '/blog' }, { l: 'Partnerships', p: '/contact' }],
  Legal:   [{ l: 'Privacy Policy', p: '/legal/privacy' }, { l: 'Terms', p: '/legal/terms' }, { l: 'Disclaimer', p: '/legal/disclaimer' }, { l: 'Cookies', p: '/legal/cookies' }],
};
