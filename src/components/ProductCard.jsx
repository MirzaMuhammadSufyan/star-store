  ...
  return (
    <>
      ...
      <div className="group bg-white border border-gray-200 rounded-lg overflow-hidden flex flex-col hover:shadow-md hover:border-amber-400 transition-all duration-200">
        ...
        {/* Image */}
        <Link to={`/product/${pid}`} className="relative block overflow-hidden bg-gray-50 h-48">
        ...
        <div className="p-3 flex flex-col gap-1.5">
          ...
          <Link to={`/product/${pid}`}>
            <h3 className="text-xs font-medium text-gray-800 line-clamp-2 leading-snug hover:text-amber-700 transition-colors">
              {title}
            </h3>
          </Link>
          ...
          <div className="flex items-center justify-between gap-1 mt-0.5">
            <div>
              ...
              <p className="text-sm font-bold text-gray-900">${parseFloat(price || 0).toFixed(2)}</p>
            </div>
